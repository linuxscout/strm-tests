...
\begin{itemize}
\item \textbf{ {{tr("First Canonical Forms")}} }
    \begin{itemize}
    {% for data in data_list %}
...
\item \textbf{ {{tr("Second Canonical Forms")}}  \aRL{ الأشكال القانونية الثانية}}
    \begin{itemize}
    {% for data in data_list %}
...
\item \textbf{ {{tr("Second Canonical Forms")}} }
    \begin{itemize}
    {% for data in data_list %}
 ...
 {% for data in data_list %}
    ...
    \begin{itemize}
        ...
        {% for explain in data.nand_sop_dict.explained %}
            \item  ${{ data.function_name }}$ = ${{ explain|normalize_formula }}$
        {% endfor %}
    \end{itemize}
 {% endfor %}
 \end{enumerate}
...
{% if RENDER_MODE == "answer" %}
     {{tr("Simplified Sum of products")}}  : ${{ data.function_name }} = {{ data.sop_dict.default|normalize_formula }}$\\
     {{tr("Simplified product of sums")}}  : ${{ data.function_name }} = {{ data.pos_dict.default|normalize_formula }}$\\

{% endif %}
{% endfor %}


\textbf{ {{tr("Logic diagram")}} }
