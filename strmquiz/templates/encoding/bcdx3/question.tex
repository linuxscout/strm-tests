...
\textbf{Carry In} & {% for c in result.carry_in %} {\scriptsize {{ '1' if c or result.carry_out[loop.index0] }}} {% if not loop.last %} & {% endif %}{% endfor %} \\
...
\section{Warning: Please check addition, there are errors.}
\begin{verbatim}
  {{ data_bcd|pprint}}
\end{verbatim}
{% endif %}
