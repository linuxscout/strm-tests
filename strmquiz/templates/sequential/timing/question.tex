...
{% set clock_signal ="$Ck$ & [timing/c/rising arrows] C 24{1C}"%}
{% set input_signals ="""$J$ &  2.25L 1H 4L 2.5H 1L 1H 0.5L 1H 1L 1H 1L 2H 2L 1H 2.75L\\\\
$K$ &  1L 4H 1L 2H 4L 3H 1L 4.25H 2L 1.75H"""%}
{% set output_signals_initial ="""$Q$ &  1L"""%}
{% set output_signals_final ="""$Q$ &  1L 2H 3L 4.5H"""%}
...
\paragraph{ Timing Latex } new version
