...
class EncodingQuestionBuilder(Question_Builder):
        ...
        "arithm": {
            ...
            "args": {
                "number_a": {
                    "type": "integer",
                    "default": 0,
                    "label": "Number A (decimal)",
                },
                "number_b": {
                    "type": "integer",
                    "default": 0,
                    "label": "Number B (decimal)",
                },
                "operation": {
                    "type": "string",
                    "default": "+",
        ...
        "gray": {
            ...
            "args": {
                "gray_number": {
                    "type": "integer",
                    "default": 0,
                    "label": "Gray number (decimal)",
                },
                "gray_sequence": {
                    "type": "integer",
                    "default": 2,
                    "label": "Gray sequence length",
                },
            },
        },
    }
    ...
    def command_ascii_text(self, args={}):
        return self.question_ascii(
            text=args.get("text", ""), method=args.get("method", "")
        )
    ...
    def command_gray(self, args={}):
        return self.question_gray(
            number=args.get("gray_number", 0),
            sequence_length=args.get("gray_sequence", 2),
        )

    def command_bcdx3(self, args={}):
        return self.question_bcd_x3(
            decimal_a=args.get("number_a", 0),
    ...
    def question_cp(self, decimal=0):
        ...
        try:
            n, a, cp1, cp2 = (
                self.qs.comp_one(8)
                if self.randomize
                else self.qs.comp_one(nbits=8, n=decimal)
            )
    ...
    def question_base(self, decimal=0, in_base=10, out_base=10):
        ...
        number_tmp, steps_from10, steps_to10, binary_mode = (
            self._compute_conversion_steps(number, in_base, out_base)
        )
    ...
    def question_bcd_x3(
        self, decimal_a=0, decimal_b=0, scheme="", method="", min_val=10, max_val=10**5
    ):
    ...
    def question_arithm(self, number_a=0, number_b=0, operation="+", base=10):
        ...
        if self.randomize:
            ...
            result = self.qs.arithm(
                number_a=number_a, number_b=number_b, base=base, operation=operation
            )
        context = {
    ...
    def question_mesure(self):
        ...
        if ask == "time":
            ...
            q = (
                f"A file was downloaded in {display_given_time:.2f} {time_unit} with a speed of "
            ...
            solution_steps = [
                {
                    "step": 1,
                    "operation": "Convert time to seconds",
                ...
                {
                    "step": 4,
                    "operation": f"Convert MB → {size_unit}",
            ...
            display_given_time = given_time / time_div
            q = (
                f"A file of size {display_size:.2f} {size_unit} was downloaded in "
            ...
            solution_steps = [
                ...
                {
                    "step": 3,
                    "operation": "Speed = Size / Time",
                    "expression": f"{size_MB:.2f} ÷ {given_time} = {speed_calc_MBps:.2f} MB/s",
                },
                {
                    "step": 4,
                    "operation": f"Convert MB/s → {speed_unit}",
        ...
        context = {
            ...
            "given": {
                ...
                "speed": {
                    "value": display_speed,
                    "unit": speed_unit,
                    "base_MBps": speed_MBps,
                },
                "time": {
                    "value": display_time,
                    "unit": time_unit,
                    "base_seconds": time_sec,
                },
            },
        }
        return context
