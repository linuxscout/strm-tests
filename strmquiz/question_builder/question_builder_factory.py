...
class question_builder_factory:
    _CATEGORY = ""
    _CATEGORIES_INFO = EncodingQuestionBuilder.get_category_info() | BooleanQuestionBuilder.get_category_info() | SequentialQuestionBuilder.get_category_info()
    _COMMANDS_INFO = EncodingQuestionBuilder.get_commands_info() | BooleanQuestionBuilder.get_commands_info() | SequentialQuestionBuilder.get_commands_info()
    _TEMPLATES_MAP = EncodingQuestionBuilder.get_templates_map() | BooleanQuestionBuilder.get_templates_map() | SequentialQuestionBuilder.get_templates_map()
    def __init__(self,):
        pass
    @staticmethod
