...
def setup_env(tmp_path):
    ...
    config_dir.mkdir()
    shutil.copy(PROJECT_ROOT/"strmquiz"/"config"/"args.default.json", tmp_path/ "config"/"args.default.json")
...
def test_load_args_uses_default_file(setup_env, tmp_path, monkeypatch,):
